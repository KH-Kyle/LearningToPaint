...
import Renderer.style_transfer.utils as utils
from Renderer.style_transfer.net import Net, Vgg16

def evaluate(content_image, output_file, style_image, cuda=False):
    style = utils.tensor_load_rgbimage(style_image, size=512)
    style = style.unsqueeze(0)    
    style = utils.preprocess_batch(style)

    style_model = Net(ngf=128)
    model_dict = torch.load("/Users/kyleghz/Desktop/CSE543/LearningToPaint/Renderer/style_transfer/models/21styles.model")
    ...
    # return output
    utils.tensor_save_bgrimage(output.data[0], output_file) #, args.cuda)
